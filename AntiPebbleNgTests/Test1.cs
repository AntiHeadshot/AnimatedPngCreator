...
class PngSuiteTests
{
    ...
    [
        ...
        "s01n3p01","s02n3p01","s03n3p01",
        "s04n3p01","s05n3p02","s06n3p02",
        "s07n3p02","s08n3p02","s09n3p02",
        "s32n3p04","s33n3p04","s34n3p04",
        "s35n3p04","s36n3p04","s37n3p04",
        "s38n3p04","s39n3p04","s40n3p04",
    ...
    public static readonly string[] PngSuiteFilesInterlaced =
    [
        "basi0g01","basi0g02","basi0g04","basi0g08","basi0g16","basi2c08","basi2c16",
        "basi3p01","basi3p02","basi3p04","basi3p08","basi4a08","basi4a16","basi6a08","basi6a16",
        "bgai4a08","bgai4a16",
        "s01i3p01","s02i3p01","s03i3p01","s04i3p01","s05i3p02","s06i3p02","s07i3p02","s08i3p02","s09i3p02",
